...
- **Lock Mp** 使用特殊技进行多段攻击时, 是否恢复MP, 默认开启锁MP模式, 也就是说特殊技, 大招多段攻击MP不会恢复. 当关闭时不锁MP, 使用大招, 特殊技时MP随着连段提升而恢复.
...
- 李烈火的特色招式是**无影脚**(投技按下A), **龙槌旋**(前Special, 接下specialx3), **升龙焰**(连段中上Special,或者上extra).
...
|**Extra**|重攻击,直接出普攻最后一招,连环踢,也可按住前后方向调整身位|**前加Special**龙炮,**上加Extra**升龙焰,**前前A**扇子打,**前加Special**龙槌旋,**下加Special**可以出三星必杀乱舞连击, **快速连按Energy**斜小跳可以进行空中跳攻击空连|
|**上Extra**|升龙焰, 挑空攻击|空中还可以接**跳下A**, 将敌人抓向地面使用投技,按**下A**可接无影脚|
|**下Extra**|转身扇打|攻击后方敌人, 如果攻击板边敌人则将敌人从版本打回屏幕中央|
|**前前A**|扇子打|**前加Special**龙炮,**下加Special**可以出三星必杀乱舞连击,**上加Special**炎龙缠身一闪攻击,**上加Extra**升龙焰, **快速连按Energy**斜小跳可以进行空中跳攻击空连|
|**前前Energy**|冲刺抓投,冲刺过程非无敌,抓投破防,对空有效|经常用在一个连段结束,对待击飞的敌人使用,可以将在空中或者地上的敌人重新抓起继续连招|
